...
import { UserGroupIcon, MenuIcon } from '@heroicons/react/solid'
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>The Gospel of Mark</title>
        <meta name="description" content="A bible App called the Word of God Risen, the gospel of Mark" />
        <link rel="icon" href="/favicon.ico" />

    
    <link
          href="https://fonts.googleapis.com/css2?family=Nunito:wght@400..700&display=swap, Montserrat,Roboto"
          rel="stylesheet"
        />   
      ...
      <div className={styles.hero}>
        ...
        MARK
         ...
         <div  className={styles.iframe1}>
                  <iframe width="100%" height="300" src="https://www.youtube.com/embed/ug4wWUad2yw?si=Aep1Dvd3-x6MVt31&autoplay=1&mute=1" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
“I will send my messenger ahead of you,
    ...
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/HGHqu9-DtXk?autoplay=1&mute=1" title="YouTube video player" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>    
...
<p className={styles.parables}>
 ...
 <p>Next</p>                                      
    ...
    <div className={styles.iframe}>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/urlvnxCaL00?autoplay=1&mute=1" title="YouTube video player" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>    

        <div className={styles.grid}>
          <div className={styles.card}>
           <h2  className={styles.chapter}>II Timothy CH I</h2>
            <p>
          ...
          <div className={styles.card}>
            <h2  className={styles.chapter}>II Timothy CH II</h2>
            <p>
                                          The Appeal Renewed
          ...
          <div
            className={styles.card}
          >
            <h2  className={styles.chapter}>II Timothy CH III</h2>
            <p>
          ...
          <div
            className={styles.card}
          >
            <h2  className={styles.chapter}>II Timothy CH IV</h2>
            <p>
             ...
             <div className={styles.iframe}>
         <iframe width="100%" height="315" src="https://www.youtube.com/embed/urlvnxCaL00?autoplay=1&mute=1" title="YouTube video player" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>      </div> 
